...
function table_create():void{
    ...
    db.query('CREATE TABLE IF NOT EXISTS book_issue (issueid INTEGER PRIMARY KEY AUTOINCREMENT, bookid INTEGER foreign key references books(bookid), memberid INTEGER foreign key references members(memberid), issue_date TEXT, return_date TEXT)').run();
